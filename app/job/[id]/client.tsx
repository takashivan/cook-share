...
export function JobDetailClient({ jobDetail }: { jobDetail: JobsDetailData }) {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      {!jobDetail.job.is_approved || jobDetail.job.status === "PENDING" || jobDetail.job.status === "DRAFT" || jobDetail.job.status === "DELETED" ? (
        <div className="flex-1 flex items-center justify-center bg-gray-50">
          <div className="text-center p-6">
            <h1 className="text-2xl font-bold mb-4">この求人は公開されていません</h1>
            <p className="text-gray-600 mb-6">
              求人が公開されるまで、詳細情報は表示されません。
            </p>
            <Link href="/">
